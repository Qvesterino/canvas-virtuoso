...
const form: ParamSpec[] = [
  { path: "form.variant", label: "Topology", kind: "scalar", min: 0, max: 3, step: 1, default: 0, identity: true, hint: "0 Cosmic clouds · 1 Curl advection · 2 Ridged veins · 3 Reaction cells." },
  { path: "form.density", label: "Density", kind: "scalar", min: 0.4, max: 6, step: 0.01, default: 2.2, hint: "How tightly the field is woven." },
  { path: "form.detail", label: "Detail", kind: "scalar", min: 1, max: 6, step: 1, default: 4, identity: true, hint: "Octaves of internal structure." },
...
export const livingFieldsFamily: FamilyDefinition = {
  ...
  variantNames: ["Cosmic clouds", "Curl advection", "Ridged veins", "Reaction cells"],
};